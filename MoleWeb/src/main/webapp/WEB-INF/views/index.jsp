		...
		<div class="login-panel">
			<div class="panel panel-primary">
				...
				<div class ="panel-body">
					<form class="form-horizontal" action="postEmail" name="userDetails" method="post">
						<div class="form-group">
							<label for="userEmail" class="col-lg-3 control-label">Email</label>
							<div class="col-lg-8">
								<input type="text" class="form-control" id="userEmail" placeholder="Email" name="email">
